...
namespace Bam.Data.Repositories
{
	...
	public abstract class Repository : Loggable, IRepository
	{
		...
		public virtual void AddType(Type type)
		{
			...
			{
				Warn("Specified type ({0}) was generated by the compiler and will not be added", type.FullName!);
				return;
			}
			_storableTypes.Add(type);
            if(!_storableTypes.Contains(typeof(CompositeKeyMap)) && type.GetProperties().Any(pi => pi.HasCustomAttributeOfType<CompositeKeyAttribute>()))
            {
        ...
        /// </summary>
        public event EventHandler Validating = null!;
        ...
        public event EventHandler ValidationFailed = null!;
        ...
        /// </summary>
        public event EventHandler Updating = null!;
        /// <summary>
        ...
        public virtual T LoadByKey<T>(ulong key) where T: class, new()
        {
	        T queryResult = Query<T>(new {Key = key}).FirstOrDefault()!;
	        if (queryResult != null && queryResult is IHasUuid result)
	        {
		        return Retrieve<T>(result.Uuid);
	        }
        ...
        public virtual IEnumerable<object> Query(dynamic query)
        {
            ...
            Dictionary<string, object> parameters = DataExtensions.ToDictionary(query);
		...
		public event EventHandler CreateFailed = null!;
		...
		[Verbosity(VerbosityLevel.Error)]
		public event EventHandler RetrieveFailed = null!;
		...
		[Verbosity(VerbosityLevel.Error)]
		public event EventHandler DeleteFailed = null!;
        ...
        public abstract IEnumerable<T> Query<T>(IQueryFilter query) where T : class, new();

        public abstract IEnumerable<object> Query(Type type, IQueryFilter query);
    }
}
